...
public class LaptopsAndNotebooks extends Utility
{
    ...
    public void  verifyProductsPriceDisplayHighToLowSuccessfully() throws InterruptedException
    {
        ...
        WebElement laptopsAndNotebook = mouseHover(By.xpath("//a[text()='Laptops & Notebooks']"));
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException
    {
        ...
        String actualMessage2 = getTextFromElement(By.xpath("//h1[contains(text(),' (0.00kg)')]"));
        Thread.sleep(2000);
        ...
        String actualMessage6 = getTextFromElement(By.xpath("//h1[contains(text(),'Checkout')]"));
        Thread.sleep(2000);
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"),"Axika");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"),"Patel");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"),"axika4387@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"),"020851243");
        sendTextToElement(By.xpath("//input[@id='input-payment-company']"),"Axiak Ltd");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"),"111");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-2']"),"Alexandra close");
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"),"SouthHarrow");
        sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"),"HA2 8QA");
        ...
        sendTextToElement(By.xpath("//body/div[@id='checkout-checkout']/div[1]/div[1]/div[1]/div[3]/div[2]/div[1]/p[2]/textarea[1]"),"Mac price is so cheaper in this site.....!");
